                                ...
                                <div class="products">
                                    <div class="product">
                                        <div class="product__img">
                                            <a href="" class="img">
                                                <span class="label">25% OFF</span>
                                                <figure><img src="{{ asset('dist/images/pro-1.png') }}" alt="pro-1"></figure>
                                            </a>
                                        </div>
                                        <div class="product__content">
                                            <div class="product__content__title">
                                                <h3><a href="">jkfdjfskdjfklsfjsdfsdfd</a>
                                                </h3>
                                            </div>
                                            <div class="product__content__price">
                                                <span class="price-old">5000000 đ</span>
                                                <span class="price-sale">6000000 đ</span>
                                            </div>
                                            <div class="product__content__meta-info">
                                                <a href="">Mua ngay</a>
                                                <div class="bnt-info">
                                                    <button class="checklogin">
